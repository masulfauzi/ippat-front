<template>
  <div class="bg-surface min-h-screen">
    ...
    <main class="lg:ml-64 min-h-screen">
      ...
      <!-- Page Title -->
      <div class="mb-8">
        <h1 class="text-3xl font-bold text-slate-900">Buat Kategori Soal Baru</h1>
        <p class="text-slate-500 mt-1">Tambahkan kategori soal beserta bobot penilaian benar/salah</p>
      </div>
      ...
      <div v-if="isSubmitting" class="flex justify-center items-center py-12">
        <div class="text-center">
          ...
          <p class="mt-3 text-slate-600">Membuat kategori soal...</p>
        </div>
      </div>
...
const handleSubmit = async () => {
  ...
  try {
    await kategoriSoalStore.createKategoriSoal({
    ...
    error.value = kategoriSoalStore.error || 'Gagal membuat kategori soal'
